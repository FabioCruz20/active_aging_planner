...
## Aviso de Uso e Atribuição

Este software foi desenvolvido por Antonio Brito e Fabio Victorino no âmbito do projeto:
Edital Acadêmico de Pesquisa: Envelhecer com Futuro (4ª Edição)
Promovido pelo Portal do Envelhecimento e Longeviver e Itaú Viver Mais.

Qualquer uso, modificação, reprodução ou redistribuição deste código — total ou parcial — exige a devida atribuição aos autores e às instituições responsáveis, conforme indicado acima.
A ausência de atribuição constitui violação das diretrizes definidas pelos autores.
